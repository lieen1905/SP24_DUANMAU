<?php
    ...
    function sendMailPass($email, $username, $pass) {
        ...
        try {
            ...
            $mail->SMTPAuth   = true;                                   //Enable SMTP authentication(kích hoạt xác thực smtp)
            $mail->Username   = '6bda0a4c1abcfc';                     //SMTP username
            $mail->Password   = '4430da6c8b9967';                               //SMTP password
            $mail->SMTPSecure = PHPMailer\PHPMailer\PHPMailer::ENCRYPTION_STARTTLS;            //Enable implicit TLS encryption(Bật mã hóa TLS ngầm)
            $mail->Port       = 587;                                    //TCP port to connect to(Cổng TCP để kết nối;); use 587 if you have set `SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS`
